...
ALTER VIEW [dbo].[viCompanyDetailed]
	AS	SELECT Company.Company_Name, Address2Company.Address_Id
		FROM Company JOIN Address2Company
		ON Company.Id = Address2Company.Address_Id
GO
PRINT N'[dbo].[View1] wird erstellt....';
